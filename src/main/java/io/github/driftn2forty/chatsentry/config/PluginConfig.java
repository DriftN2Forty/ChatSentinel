package io.github.driftn2forty.chatsentry.config;
...
public final class PluginConfig {
    ...
    public String getStaffPermission() { return config.getString("actions.escalate.staff-permission", "chatsentry.staff"); }
    ...
    public String getSqliteFile() { return config.getString("storage.sqlite.file", "chatsentry.db"); }
    ...
    public String getMysqlDatabase() { return config.getString("storage.mysql.database", "chatsentry"); }
    ...
    public String getPostgresqlDatabase() { return config.getString("storage.postgresql.database", "chatsentry"); }
